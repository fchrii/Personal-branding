...
export default function Page() {
  const missionStatement =
    "Saya Fachri, seorang yang bergerak di bidang desain, coding, dan servis elektronik. Dalam desain, saya menawarkan layanan pembuatan logo, UI/UX, poster, banner, dan berbagai kebutuhan visual lainnya. Di bidang coding, saya berfokus pada pengembangan web modern dengan Next.js dan Laravel. Selain itu, saya juga menyediakan layanan perbaikan perangkat seperti komputer, laptop, printer, HP, hingga barang elektronik lainnya. Website ini saya buat sebagai ruang untuk memamerkan karya sekaligus memudahkan Anda terhubung dengan layanan yang saya tawarkan."
  ...
  const timelineEntries = [
    {
      ...
      description:
        "Kita membuat jasa design; Design web (UI/UX), Design Poster, Design Banner, Design Layyard, dan Design-design lainnya,",
        ...
        <div className="relative z-10">
          <div className="container mx-auto px-6 mb-16">
            <div className="text-center">
              <h2 className="text-4xl md:text-6xl font-black tracking-wider mb-6 text-gray-900">APA SAJA YANG BISA<br/>KITA LAKUKAN?</h2>
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto">
                Berikut beberapa hal yang bisa kami tawarkan kepada anda dengan jelas.
              </p>
            </div>
          </div>
